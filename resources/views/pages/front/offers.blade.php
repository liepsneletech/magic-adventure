        ...
        <div class="container">
            ...
            <div class="flex mb-8 justify-between border px-7 py-4 rounded-[35px] border-pink-400">
                ...
                <form class="search-form" action="{{ route('offers') }}">
                    <input type="text" placeholder="Ieškoti..." class="search-input rounded-[20px] border-none"
                        name="s" value="@if (isset($offers) && count($offers) === 0) {{ $searchTerm }} @endif">
            ...
            <div class="rounded-lg grid grid-cols-3 gap-8">
                @forelse ($offers as $offer)
                    <div class="bg-white bg-no-repeat rounded-lg p-5 items-center justify-between gap-5 drop-shadow-sm">
                        ...
                        <div class="grid grid-cols-1 gap-5 items-start">
                            ...
                            <div class="flex align-end justify-between">
                                ...
                                <p class="text-green-500 text-3xl font-['Bebas_Neue'] self-end">{{ $offer->price }}
                                    &euro;
                                </p>
                                @auth
