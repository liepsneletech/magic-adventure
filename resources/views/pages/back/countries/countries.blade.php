    ...
    <div class="bg-gray-100 min-h-screen pt-12">
        <div class="container">
            <div class="grid grid-cols-1 items-center">
                <h1
                    class="text-center text-green-500 mb-5 text-4xl font-['Bebas_Neue'] justify-self-center col-start-1 col-end-2 row-start-1 row-end-2">
                    Šalių
                    sąrašas
                </h1>
            ...
            <div class="flex flex-col gap-5 bg-white rounded-lg p-16 drop-shadow-sm">
